...
Ext.define('Ext.ux.CheckColumn', {
    ...
    constructor: function() {
		...
		this.checkboxDisable=arguments[0].checkboxDisable;
    ...
    renderer : function(value, metaData, record, rowIndex, colIndex){
		...
		if (this.columns[colIndex].checkboxDisable) {
            cls.push(cssPrefix + 'grid-checkheader-disable');
        }
        return '<div class="thumb chex"><table><tr><td><div class="' + cls.join(' ') + '">&#160;</div></td></tr></table></div>';
    }
});
